...
public interface WebServicesAPI {
    ...
    @POST(WebServicesURLS.KWebGetMyRFPs)
    Call<GetMyRfpsResponse> getMyRFPs(@Body GetMyRfpsRequest req);


    @POST(WebServicesURLS.KWebRateProposal)
    Call<SubmitOrderResponse> submitRatingOrder(@Body SubmitOrderRequest req);
